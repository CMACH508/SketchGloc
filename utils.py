...
def load_checkpoint(sess, checkpoint_path,id=0):
    ...
    if id ==0 :
        ...
        path = './ckpt_ds1_999_stnum/vector-' + str(id)
...
class DataLoader(object):
    ...
    def _get_batch_from_indices(self, indices,PROB=0.):
        ...
        seq_len = np.array(seq_len, dtype=int)
        #print(seq_batch,seq_bias_batch)
...
#            seq_ori_batch.append(data_ori)
    ...
    def _get_batch_from_indices_extra(self, indices,PROB=0.3):
        """Given a list of indices, return the potentially augmented batch."""
        seq_batch = []
        png_batch = []
        label_batch = []
